...
const slides = [
  {
    ...
    specs: [
      { icon: '/cards/cama.svg', label: 'Studio e 1 dorm.' },
      { icon: '/cards/area.svg', label: '24 a 54m²' },
      { icon: '/cards/Frame-2.svg', label: 'Sem vaga' },
      { icon: '/cards/plantas.svg', label: 'Rooftop com vista livre' },
    ],
  },
  {
    num: '02',
  ...
  },
  {
    ...
    specs: [
      ...
      { icon: '/cards/Frame-2.svg', label: 'Terraço desc./coberto' },
      { icon: '/cards/plantas.svg', label: 'Área privativa' },
    ],
  },
];
